...
public class MetricsAggregationServiceImpl implements MetricsAggregationService {
    ...
    @Override
    @Cacheable("totalClicksForDataSource")
    ...
    @Override
    @Cacheable("totalClicksForCampaign")
    ...
    @Override
    @Cacheable("ctrGroupByDataSource")
    ...
    @Override
    @Cacheable("totalImpressionsGroupedByDataSource")
    ...
    @Override
    @Cacheable("totalImpressionGroupedByCampaign")
